...
/* URL pública do site. A Vercel injeta VERCEL_PROJECT_PRODUCTION_URL com o
   domínio de produção do projeto, então isso se ajusta sozinho — inclusive
   no dia em que a Shay tiver um domínio próprio. Sem isso, as meta tags do
   OpenGraph apontam para um domínio que não existe e o preview do link
   (WhatsApp, Instagram, Facebook) fica sem imagem. */
